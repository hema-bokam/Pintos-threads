...
struct thread
  {
    ...
    int original_priority;              /* Maintains original priority of the thread*/
    ...
    int nice_val;                           /* Thread's nice value */
    fixed_point_t recent_cpu;               /* Thread's recent cpu value */
...
void recalculate_thread_priority(struct thread *t);
